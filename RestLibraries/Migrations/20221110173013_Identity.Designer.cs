...
namespace RestLibraries.Migrations
{
    ...
    [Migration("20221110173013_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestLibraries.Auth.LibrariesUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RestLibraries.Auth.LibrariesUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RestLibraries.Data.Entities.City", b =>
                {
                    b.HasOne("RestLibraries.Auth.LibrariesUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
